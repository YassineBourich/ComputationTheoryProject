...
class SafetyTest:
    def __init__(self, symb_model):
        ...
        for i in range(20, 41):
            for j in range(20, 41):
                for k in range(0, 10):
                    self.Qs1.add(k * 100 + i * 10 + j)  # vect_min = [2, 2, -pi], and vect_max = [4, 4, pi]
    ...
    def get_concrete_model(self, Qs, Qs_domain):
        ...
        print(safety_controller.R_list)
        print(len(safety_controller.R_list))
